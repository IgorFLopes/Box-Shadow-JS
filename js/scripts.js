class BoxShadowGenerator {
    ...
    constructor(
        ...
        // transformando propriedade no objeto
    ...
    // Vou criar um metodo "Initialize" pensando que metodos é como se fosse funções (colocar os valores dos input de referência)
    initialize() {
        this.horizontalRef.value = this.horizontal.value;
        this.verticalRef.value = this.vertical.value;
        this.blurRef.value = this.blur.value;
        this.spreadRef.value = this.spread.value;
        this.colorRef.value = this.colorRef.value;
        this.opacityRef.value = this.opacityRef.value;
...
// Criando classe com novo objeto
...
// console.log(boxShadow)
// Aqui estou inicializando de verdade
...
horizontal.addEventListener("input", (e) => {
    ...
    // criar uma função que vai se chamar "updateValue()"
...
// Agora vamos fazer um evento

rulesArea.addEventListener("click", () => {

    const rules = rulesArea.innerText.replace(/^\s*\n/gm, "")

    // clipboard que é nosso "ctrl C"
